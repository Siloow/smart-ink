    ...
    <div className="dashboard">
      ...
      <div className="main-content">
        ...
        <div className="new-project-row">
          <div className="new-project-card" onClick={handleNewScene} role="button" tabIndex={0} onKeyDown={(e) => e.key === 'Enter' && handleNewScene()}>
          ...
          <div className="file-grid">
            {filteredScenes.map((scene) => (
              <div key={scene.id} className="file-card">
                ...
                >
                  {scene.thumbnail ? (
                    <img src={scene.thumbnail} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                  ) : (
